...
DECLARE cursor_prod SCROLL CURSOR FOR SELECT * FROM products;

FETCH LAST FROM cursor_prod;

MOVE BACKWARD 4 FROM cursor_prod;

FETCH BACKWARD FROM cursor_prod;

MOVE BACKWARD 7 FROM cursor_prod;
